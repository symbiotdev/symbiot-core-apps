...
import { DateHelper, getValueByObjectPath } from '@symbiot-core-apps/shared';
import {
  ...
  const {
    ...
    defaultValues: step.elements.reduce(
      (stepObj, el) => ({
        ...stepObj,
        [el.props.name]:
          getValueByObjectPath(formValue, el.props.name) ||
                      ...
                      <View marginTop="$5">
                        ...
                        {el.type === 'avatar' && (
                          <AvatarPicker
                            ...
                            size={el.props.size || 140}
                            borderRadius={el.props.borderRadius}
                            allowsEditing={el.props.allowsEditing}
                            marginTop="$10"
                            onAttach={onChange}
                          />
                        )}
